...
function AddCottonPurchaseForm({ state, accountList, addcottonpurchase }) {
  React.useEffect(() => {
    accountList();
  }, [accountList]);
  ...
  function getNetAmmount() {
    if (purchaseAmmount !== 0 && Commision !== 0 && vehicalRent !== 0) {
...
export default connect(mapStateToProps, { accountList, addcottonpurchase })(
  AddCottonPurchaseForm
);
