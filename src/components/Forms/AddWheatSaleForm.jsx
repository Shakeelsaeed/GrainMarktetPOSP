...
import { accountList, addwheatsale } from "../../redux-implementation/actions";

function AddWheatSaleForm({ state, accountList, addwheatsale }) {
  React.useEffect(() => {
    accountList();
  }, [accountList]);
  ...
  function getNetAmmount() {
    if (saleAmmount !== 0 && barDana !== 0 && vehicalRent !== 0) {
...
export default connect(mapStateToProps, { accountList, addwheatsale })(
  AddWheatSaleForm
);
